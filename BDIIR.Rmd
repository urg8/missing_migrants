...
author: 
- name: Riya Chanduka
  affiliation: chanduka@terpmail.umd.edu
...
```{r regions_and_year, warning=FALSE, fig.cap="Total number of missings and deaths by region"}
...
```{r, out.width = "500px", fig.cap="Total Number of Incidents over time"}
# This result was created in the accompanying python jupyter notebook
knitr::include_graphics('images/Total_Number_of_Deaths_and_Missing.png')
```
...
```{r stacked_bar_total, message=FALSE, warning=FALSE, fig.cap="Precentage of incident by Mediterranean route"}
...
```{r by_month, message=FALSE, warning=FALSE, fig.cap="Number of incidents by month"}
...
```{r, fig.cap="OLS Output"}
# This result was created in the accompanying python jupyter notebook
knitr::include_graphics('images/ANOVA_Test_results.png')
```

```{r, fig.cap="Overall ANOVA Result"}
# This result was created in the accompanying python jupyter notebook
knitr::include_graphics('images/Anova_Overall.png')
```
...
```{r, fig.cap="Tuckey test results I"}
# This result was created in the accompanying python jupyter notebook
knitr::include_graphics('images/Post-AD-HOC-testing1.png')
```

```{r, fig.cap="Tuckey test results I"}
# This result was created in the accompanying python jupyter notebook
knitr::include_graphics('images/Post-AD-HOC-testing2.png')
```
...
```{r, fig.cap="T-Test descriptive"}
# This result was created in the accompanying python jupyter notebook
knitr::include_graphics('images/t-test_descriptive.png')
```

```{r, fig.cap="T-Test results"}
# This result was created in the accompanying python jupyter notebook
knitr::include_graphics('images/T-test_table.png')
```
...
```{r map_static, cache=TRUE, message=FALSE, warning=FALSE, fig.cap="Incident and route map"}
