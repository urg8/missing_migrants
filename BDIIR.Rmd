...
packages <- c("ggplot2", "plotly", "readr", "RColorBrewer", "tidyverse", "grid", "dplyr", "gridExtra"
              ...
              ,"animation", "gifski", "epitools", "scales", "withr", "transformr", "devtools")
...
```{r stacked_bar_total, eval=FALSE, message=FALSE, warning=FALSE}
...
```{r map_static, cache=TRUE, eval=FALSE, message=FALSE, warning=FALSE}
...
```{r map_animated, cache = TRUE, eval=FALSE, message=FALSE, warning=FALSE}
